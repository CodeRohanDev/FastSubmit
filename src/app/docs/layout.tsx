...
import { Zap, Book, Code, Send, Database, Key, FileText, Layers, AlertCircle, Gauge, Shield } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#fafafa]">
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
          <div className="flex items-center gap-6">
            <Link href="/" className="block">
              ...
              <p className="text-[9px] text-gray-400 -mt-0.5">by Hostspica</p>
            </Link>
      ...
      <div className="flex pt-16">
        {/* Sidebar */}
        <aside className="fixed left-0 top-16 w-60 h-[calc(100vh-4rem)] border-r border-gray-100 bg-[#fafafa] overflow-y-auto">
          <nav className="p-4">
