  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="space-y-8">
        <section>
          <h2 className="text-lg font-semibold mb-3">Why verify domains?</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-3">How to verify a domain</h2>
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-medium mb-2">Step 1: Add your domain</h3>
              <p className="text-sm text-gray-600 mb-2">
                Go to your form settings and click "Add domain". Enter your domain name (e.g., <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs">example.com</code>).
              </p>
            </div>

            <div>
              <h3 className="text-sm font-medium mb-2">Step 2: Add DNS TXT record</h3>
              <p className="text-sm text-gray-600 mb-3">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 font-mono text-xs space-y-2">
                <div className="grid grid-cols-3 gap-4 text-gray-500 font-sans">
                  <span>Type</span>
                  <span>Name</span>
                  <span>Value</span>
                </div>
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <span className="text-gray-600">fastsubmit-verify=abc123...</span>
                </div>
              </div>
            </div>

            <div>
              <h3 className="text-sm font-medium mb-2">Step 3: Verify</h3>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-3">DNS provider guides</h2>
          <div className="space-y-3">
            <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <summary className="text-sm font-medium cursor-pointer">Cloudflare</summary>
            ...
            <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <summary className="text-sm font-medium cursor-pointer">GoDaddy</summary>
              <ol className="mt-3 space-y-2 text-sm text-gray-600 list-decimal list-inside">
            ...
            <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <summary className="text-sm font-medium cursor-pointer">Namecheap</summary>
              <ol className="mt-3 space-y-2 text-sm text-gray-600 list-decimal list-inside">
            ...
            <details className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <summary className="text-sm font-medium cursor-pointer">Other providers</summary>
        ...
        <section>
          ...
          <div className="space-y-3">
            <div>
              <h3 className="text-sm font-medium mb-1">Verification fails</h3>
            ...
            <div>
              <h3 className="text-sm font-medium mb-1">Check DNS propagation</h3>
              <p className="text-sm text-gray-600">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-3">Using verified domains</h2>
          <p className="text-sm text-gray-600 mb-3">
