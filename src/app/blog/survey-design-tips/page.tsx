...
export const metadata: Metadata = {
  ...
  description: 'Create surveys that people actually complete. Learn 10 proven tips to design surveys with higher response rates and better data quality.',
  keywords: ["survey design tips","survey best practices","increase survey response rate","survey optimization"],
}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <header className="mb-12">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Create surveys that people actually complete. Learn 10 proven tips to design surveys with higher response rates and better data quality.
            </p>
          </header>
